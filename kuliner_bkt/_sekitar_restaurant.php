<?php
    ...
    $querysearch="SELECT id, name, address, cp, open, close, capacity, employee, mushalla, park_area, bathroom, geom, ST_Y(ST_CENTROID(geom)) as lat, ST_X(ST_CENTROID(geom)) as lng,
