...
ST_Y(ST_CENTROID(culinary_place.geom)) As lat from culinary_place join detail_facility_culinary on 
culinary_place.id=detail_facility_culinary.id_culinary_place where detail_facility_culinary.id_facility in ($c) 
group by id";
