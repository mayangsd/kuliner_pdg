<?php
    ...
    $querysearch= "SELECT detail_culinary_place.id_culinary_place,angkot.id,angkot.route_color, detail_culinary_place.id_angkot,culinary_place.name, 
    ST_X(ST_Centroid(culinary_place.geom)) AS lng, ST_Y(ST_CENTROID(culinary_place.geom)) As lat FROM 
